...
causing the co-moving Hubble distance $(a H)^{-1} = 1/\dot a$ to shrink by a factor perhaps as large as $e^{70}$. 
...
\end{align}
The solution to these equations of motion is called inflationary when the co-moving Hubble distance shrinks. 
...
The primary quantity we will calculate is the Hubble rate as a function of the remaining number of e-folds of inflation
\begin{align}
H(N)
\end{align}
