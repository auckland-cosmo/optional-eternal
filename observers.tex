...
\end{align}
 ...
 %Solving the horizon and flatness problems requires $(a H)^{-1}$ to shrink by a sufficient factor, usually $e^{50}$  - $e^{60}$, with a smaller amount needed if the reheating scale is well below the GUT scale.
